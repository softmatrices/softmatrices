    ...
    <section ref={ref} id="why-choose-us" className="section-padding bg-gradient-to-b from-white to-neutral-50">
      <div className="container-custom">
        <div className={`text-center mb-16 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <h2 className="text-3xl md:text-5xl font-display font-bold mb-6 px-5">
            <span className="text-gradient">Why Choose Softmatrices</span>
          </h2>
          
          <p className="text-lg text-neutral-600 max-w-2xl mx-auto text-justify px-8">
        ...
        <div className={`text-center mt-16 transition-all duration-1000 delay-1000 ${
          ...
          <div className="glass-card rounded-2xl p-8 max-w-3xl mx-auto">
            ...
            <p className="text-neutral-600 mb-6 text-justify">
